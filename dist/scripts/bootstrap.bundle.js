            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _this3.getFolderOfFileInBlob(blob, '#main-ul-repositoryThree');
