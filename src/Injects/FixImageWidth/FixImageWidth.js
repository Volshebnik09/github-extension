...
export default class {
    ...
    pictureFullSize(){
        require("./style.scss")
        let body = $('body')
        let imgHolderMain = $('#repo-content-pjax-container > div > div > div.Box.mt-3 .text-center');

        let img =  $('#repo-content-pjax-container > div > div > div.Box.mt-3 .text-center img');
